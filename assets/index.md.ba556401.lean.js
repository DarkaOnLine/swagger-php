import{_ as i,c as p,a as t,b as l,w as s,r as c,o as r,d as n,e}from"./app.c5f08357.js";const w='{"title":"Home","description":"","frontmatter":{"home":true,"actionText":"User Guide \u2192","actionLink":"/guide/","features":[{"title":"OpenAPI conformant","details":"Generate OpenAPI documents in version 3.0 or 3.1."},{"title":"Document your API inside PHP source code","details":"Using swagger-php lets you write the API documentation inside the PHP source files which helps keeping the documentation up-to-date."},{"title":"Annotation and Attribute support","details":"Annotations can be either docblocks or PHP 8.1 attributes."}]},"headers":[{"level":3,"title":"1. Install with composer:","slug":"_1-install-with-composer"},{"level":3,"title":"2. Update your code","slug":"_2-update-your-code"},{"level":3,"title":"3. Generate OpenAPI documentation","slug":"_3-generate-openapi-documentation"},{"level":3,"title":"4. Explore and interact with your API","slug":"_4-explore-and-interact-with-your-api"},{"level":2,"title":"Links","slug":"links"}],"relativePath":"index.md"}',u={};function d(k,a,h,m,g,f){const o=c("codeblock");return r(),p("div",null,[a[2]||(a[2]=t(`<h3 id="_1-install-with-composer" tabindex="-1">1. Install with composer: <a class="header-anchor" href="#_1-install-with-composer" aria-hidden="true">#</a></h3><div class="language-shell"><pre><code><span class="token operator">&gt;</span> <span class="token function">composer</span> require zircote/swagger-php
</code></pre></div><h3 id="_2-update-your-code" tabindex="-1">2. Update your code <a class="header-anchor" href="#_2-update-your-code" aria-hidden="true">#</a></h3><p>Add <code>swagger-php</code> attributes (or legacy annotations) to your source code.</p><p>\u26A0\uFE0F <code>doctrine/annotations</code> is going to be deprecated in the future, so wherever possible attributes should be used.</p>`,5)),l(o,{id:"minimal"},{at:s(()=>a[0]||(a[0]=[n("div",{class:"language-php"},[n("pre",null,[n("code",null,[n("span",{class:"token php language-php"},[n("span",{class:"token delimiter important"},"<?php"),e(`
...
`),n("span",{class:"token punctuation"},"{"),e(`
    ...
    `),n("span",{class:"token punctuation"},"}"),e(`
`),n("span",{class:"token punctuation"},"}"),e(`
`)])])])],-1)])),an:s(()=>a[1]||(a[1]=[n("div",{class:"language-php"},[n("pre",null,[n("code",null,[n("span",{class:"token php language-php"},[n("span",{class:"token delimiter important"},"<?php"),e(`
